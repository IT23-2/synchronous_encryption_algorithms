...
# Функция для оценки вероятности того, что текст является осмысленнымAdd commentMore actions
...
# Функция взлома шифра Цезаря с использованием частотного анализа.Add commentMore actions
def break_cipher(text, language='ru', max_candidates=3):
    ...
    # Возвращаем лучшие вариантыAdd commentMore actions
