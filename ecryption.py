...
# Функция шифрования с использованием OTPAdd commentMore actions
def encrypt(message, key):Add commentMore actions
    # Преобразуем сообщение в байты
    message_bytes = message.encode('utf-8')

if len(key) != len(message_bytes):Add commentMore actions
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Шифрование и дешифрование с использованием одноразового блокнота (OTP)')Add commentMore actions
    ...
    if args.mode == 'encrypt':Add commentMore actions
        ...
        try:Add commentMore actions
                ...
                if args.key_file:
                    ...
                    if key:Add commentMore actions
                        print(f"Ключ загружен из файла: {args.key_file}")

                 if not key:Add commentMore actions
                        ...
                        if args.ciphertext_file:
                            ...
                            if ciphertext:Add commentMore actions
                                print(f"Шифротекст загружен из файла: {args.ciphertext_file}")

                        if not ciphertext:Add commentMore actions
                        ...
                        # Сохраняем расшифрованное сообщение в файл, если указан путьAdd commentMore actions
