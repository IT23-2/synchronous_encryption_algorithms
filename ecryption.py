...
# Функция шифрования шифром ВиженераAdd commentMore actions
...
# Функция дешифрования шифра ВиженераAdd commentMore actions
...
message = input("Введите текст для шифрования: ")Add commentMore actions
        ...
        if decrypted_text == message:
            ...
            print("\nОшибка: расшифрованный текст не совпадает с исходным.")Add commentMore actions
            
    except Exception as e:
        print(f"Произошла ошибка: {e}")Add comment
